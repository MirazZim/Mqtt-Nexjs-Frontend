    ...
    return (
        <div className="space-y-2">
            <div className="flex items-center gap-2 pb-2 border-b border-gray-200 dark:border-gray-600">
                ...
                <h2 className="text-base font-bold text-gray-800 dark:text-gray-200">{t('Device Status')}</h2>
            </div>

            <div className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 px-2 py-1.5 rounded-md">
            ...
            <div className="space-y-2">
                ...
                <div className={`rounded-lg p-2 border transition-all duration-300 ${brokerStatus.connected
                    ...
                    <div className="flex items-start gap-2">
                        <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${brokerStatus.connected ? 'bg-green-100 dark:bg-green-800/50' : 'bg-red-100 dark:bg-red-800/50'
                            }`}>
                            <FaWifi className={`text-sm ${brokerStatus.connected ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                                }`} />
                        </div>

                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 mb-0.5">
                                <h4 className="text-xs font-semibold text-gray-800 dark:text-gray-200">{t('MQTT Broker')}</h4>
                            ...
                            <p className={`text-xs font-medium mb-1 ${brokerStatus.connected ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400'
                                }`}>
                ...
                <div className={`rounded-lg p-2 border transition-all duration-300 ${sensorStatus.active
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 mb-0.5">
                                <h4 className="text-xs font-semibold text-gray-800 dark:text-gray-200">{t('Sensor Data Stream')}</h4>
                ...
                {sensorStatus.active ? (
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 rounded-lg p-3 border border-purple-200 dark:border-purple-700">
                        <div className="text-center">
                            <div className="inline-flex items-center justify-center w-10 h-10 bg-white dark:bg-gray-700 rounded-full shadow-sm mb-1.5">
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-600 text-center">
                        <div className="inline-flex items-center justify-center w-10 h-10 bg-white dark:bg-gray-600 rounded-full shadow-sm mb-1.5">

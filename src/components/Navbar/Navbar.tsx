                        ...
                        <div className="hidden lg:flex items-center gap-3">
                            {user ? (
                                <>
                                    ...
                                    <div className="flex items-center gap-3 px-4 py-2 bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl border border-white/30 dark:border-gray-700/30 shadow-lg min-w-[180px]">
                                        <div className="w-8 h-8 rounded-full bg-linear-to-br from-teal-500 to-blue-600 flex items-center justify-center text-white text-sm font-bold shadow-md shrink-0">
                                            {user.username.charAt(0).toUpperCase()}
                                        </div>
                                        <div className="min-w-[100px]">
                                            <p className="text-xs text-gray-600 dark:text-gray-400 leading-none whitespace-nowrap">{t('Welcome back,')}</p>
                                ...
                                <>
                                    <Link
                                        href={`/${lng}/login`}
                                        className="px-5 py-2 text-gray-700 dark:text-gray-300 bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl rounded-xl font-medium text-sm no-underline transition-all duration-300 hover:bg-white/70 dark:hover:bg-gray-800/70 border border-white/30 dark:border-gray-700/30 min-w-[110px] text-center whitespace-nowrap"
                                    >
                                        {t('Login')}
                                    </Link>
                                    <Link
                                        href={`/${lng}/register`}
                                        className="px-5 py-2 bg-linear-to-r from-teal-500/90 to-blue-600/90 backdrop-blur-xl text-white rounded-xl font-medium text-sm no-underline transition-all duration-300 hover:shadow-lg hover:shadow-teal-500/50 hover:scale-105 border border-teal-400/30 hover:from-teal-500 hover:to-blue-600 min-w-[130px] text-center whitespace-nowrap"
                                    >
                                        {t('Get Started')}
                                    </Link>
                                </>
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        {user ? (
                            <>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center justify-between px-4 py-3 bg-white/50 dark:bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-300 hover:shadow-md"
                                    >
                                        ...
                                        <div className={`w-12 h-6 rounded-full p-1 transition-colors duration-300 ${isDarkMode ? 'bg-indigo-600' : 'bg-gray-300'}`}>
                            ...
                            <>
                                {/* Dark/Light Mode Toggle for Non-logged Users */}
                                <div className="space-y-2">
                                    <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider px-1">
                                        {t('Theme')}
                                    </p>
